    ...
    const systemRoles = [
      ...
      },
      {
        ...
        permissionKeys: [
          ...
          'vehicles:update',
          'serving_areas:read',
          'serving_areas:create',
          'serving_areas:update',
          'drivers:read',
          'drivers:create',
          'drivers:update',
          'gps_devices:read',
      ...
      },
      {
        ...
        permissionKeys: ['users:read', 'users:update', 'telemetry:read', 'events:read', 'geofences:read', 'notifications:read', 'settings:tenant:read', 'settings:tenant:update'],
      },
      {
        key: 'VIEWER',
        name: 'Viewer',
        description: 'Read-only access',
        permissionKeys: ['users:read', 'roles:read', 'permissions:read', 'telemetry:read', 'events:read', 'geofences:read', 'notifications:read', 'settings:tenant:read'],
      },
    ];
